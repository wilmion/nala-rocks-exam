export const Spanish = {
  languajeLabel: "Idioma",
  languajeLabelOpt1: "Inglés",
  languajeLabelOpt2: "Español",
  tableNotCSVHelper: "Comencemos cargando tu archivo csv.",
  tableActionsTitle: "ORGANIGRAMA NALA",
  tableActionsBtn1: "Imprimir",
...
export const English = {
  languajeLabel: "Languaje",
  languajeLabelOpt1: "English",
  languajeLabelOpt2: "Spanish",
  tableNotCSVHelper: "Let's start to upload your csv file.",
  tableActionsTitle: "NALA ORGANIGRAM",
  tableActionsBtn1: "Print",
